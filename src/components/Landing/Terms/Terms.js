		...
		<div className="container mb-120">
			...
			<Paragraph
				...
				texts={[
					...
					"<br>Además, a efecto de dar cumplimiento a lo establecido en la Ley Federal de Protección de Datos Personales en Posesión de Particulares, todo dato personal que sea recabado a través del SITIO WEB, será tratado de conformidad con los principios de licitud, calidad, finalidad, lealtad, y responsabilidad. Todo tratamiento de datos personales quedará sujeto al consentimiento de su titular. <strong>DISTRITOPYME podrá compartir la información y documentación del USUARIO con terceros Otorgantes de Crédito como son Impulso Distrito, S.A.P.I. de C.V. (ImpulsoMx), Unifin Financiera, S.A.B. de C.V. (Uniclick), Pretmex, S.A. de C.V. (Pretmex), Advantech Servicios Financieros, S.A.P.I. de C.V., SOFOM E.N.R. (Aspiria), y Bien para Bien, S.A.P.I. de C.V., SOFOM E.N.R. (Bien para Bien), Cumplomex, S.A. de C.V. (Cumplo), APJUSTO, S.A.P.I. de C.V., SOFOM E.N.R., y JUSTO LEASE, S.A.P.I. de C.V. (CREDIJUSTO),  Mundi Trade, INC (Mundi), Factor Expres, S.A.P.I. de C.V. SOFOM E.N.R. (FACTOR EXPRES), y AV Socios de Capital, S.A.P.I. de C.V.  con la finalidad de dar cumplimiento a su principal servicio, que es ofrecer al USUARIO la mayor cantidad y las mejores propuestas de financiamiento posibles que se adecuen a sus necesidades, en todo caso se dará la mayor diligencia y cuidado a este tipo de datos.</strong>",
