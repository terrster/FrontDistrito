		...
		<div className="container mb-120">
			...
			<Paragraph
				...
				texts={[
					...
					"<br><strong>Distrito Pyme S.A. de C.V.</strong> se reserva el derecho de retirar todos aquellos comentarios y aportaciones que vulneren la ley, el respeto a la dignidad de la persona, que sean discriminatorios, atenten contra los derechos de terceros o el orden público, o bien, que a su juicio no resulten adecuados para su publicación.",

					"<br>En cualquier caso, <strong>Distrito Pyme S.A. de C.V.</strong> no será responsable de las opiniones vertidas por los USUARIOS a través de comentarios o publicaciones que estos realicen.",
			...
			<Paragraph
				...
				texts={[
					"<br>DISTRITOPYME no garantiza de ningún modo la continuidad y disponibilidad de los contenidos, productos o servicios ofrecidos a través del SITIO WEB, no obstante, DISTRITOPYME llevará a cabo las acciones que de acuerdo a sus posibilidades le permitan mantener el buen funcionamiento del SITO WEB, sin que esto suponga alguna responsabilidad de parte de <strong>Distrito Pyme S.A. de C.V.</strong>",

					"<br>De igual forma <strong>Distrito Pyme S.A. de C.V.</strong> no será responsable ni garantiza que el contenido o software al que pueda accederse a través del SITIO WEB, se encuentre libre de errores, software malicioso, o que pueda causar algún daño a nivel de software o hardware en el equipo a través del cual el USUARIO accede al SITIO WEB.",

					"<br>DISTRITOPYME tampoco se hace responsable de los daños que pudiesen ocasionarse por un uso inadecuado del SITIO WEB. En ningún caso <strong>Distrito Pyme S.A. de C.V.</strong> será responsable por las pérdidas, daños o perjuicios de cualquier tipo que surjan por el sólo acceso o utilización del SITIO WEB."
			...
			<Paragraph
				...
				texts={[
					...
					"<br>Además, a efecto de dar cumplimiento a lo establecido en la Ley Federal de Protección de Datos Personales en Posesión de Particulares, todo dato personal que sea recabado a través del SITIO WEB, será tratado de conformidad con los principios de licitud, calidad, finalidad, lealtad, y responsabilidad. Todo tratamiento de datos personales quedará sujeto al consentimiento de su titular. <strong>DISTRITOPYME podrá compartir la información y documentación del USUARIO con terceros Otorgantes de Crédito como son Impulso Distrito, S.A.P.I. de C.V. (ImpulsoMx), Unifin Financiera, S.A.B. de C.V. (Uniclick), Pretmex, S.A. de C.V. (Pretmex), Advantech Servicios Financieros, S.A.P.I. de C.V., SOFOM E.N.R. (Aspiria), Bien para Bien, S.A.P.I. de C.V., SOFOM E.N.R. (Bien para Bien), Cumplomex, S.A. de C.V. (Cumplo), APJUSTO, S.A.P.I. de C.V., SOFOM E.N.R., JUSTO LEASE, S.A.P.I. de C.V. (CREDIJUSTO),  Mundi Trade, INC (Mundi), Factor Expres, S.A.P.I. de C.V. SOFOM E.N.R. (FACTOR EXPRES), AV SOCIOS DE CAPITAL S.A.P.I. DE C.V. (AV Capital), HAYCASH S.A.P.I. DE C.V. (HayCash), Dimex S.A. de C.V. (Dimex), UKU S.A.P.I. de C.V. (PagaLoop), First Home Solutions S.A.P.I. de C.V. (iBan), “ION FINANCIERA”, SOCIEDAD ANÓNIMA PROMOTORA DE INVERSIÓN DE CAPITAL VARIABLE, SOCIEDAD FINANCIERA DE OBJETO MÚLTIPLE, ENTIDAD REGULADA, SGS Soluciones a tu Medida SAPI de CV SOFOM ENR (Amifin), HAPPY DAYS TECH, S.A.P.I. DE C.V. (delt.ai), Prestadora de Servicios Ciclomart S.A.P.I de C.V (Creze), Financiera Cualli, S.A.P.I. de C.V., SOFOM, E.N.R y Banca Afirme, S.A. con la finalidad de dar cumplimiento a su principal servicio, que es ofrecer al USUARIO la mayor cantidad y las mejores propuestas de financiamiento posibles que se adecuen a sus necesidades, en todo caso se dará la mayor diligencia y cuidado a este tipo de datos.</strong>",
					...
					"<br>El tratamiento de datos personales se limitará al cumplimiento de las finalidades previstas en el Aviso de Privacidad el cual se encontrará disponible en la siguiente dirección electrónica:",

					"<br><p><a href='https://www.distritopyme.com/privacidad'>https://www.distritopyme.com/privacidad</a></p>",
					...
					"<br><strong>Distrito Pyme S.A. de C.V.</strong> se reserva el derecho a modificar su Política de Privacidad, de acuerdo con sus necesidades o derivado de algún cambio en la legislación. El acceso o utilización del SITIO WEB después de dichos cambios, implicará la aceptación de estos cambios.",

					"<br>Por otra parte, el acceso al SITIO WEB puede implicar la <strong>utilización de cookies</strong>, las cuales, son pequeñas cantidades de información que se almacenan en el navegador utilizado por el USUARIO. Las cookies facilitan la navegación, la hacen más amigable, y no dañan el dispositivo de navegación, para ello, pueden recabar información para ingresar al SITIO WEB, almacenar las preferencias del USUARIO, así como la interacción que este tenga con el SITIO WEB, como por ejemplo: la fecha y hora en la que se accede al SITIO WEB, el tiempo que se ha hecho uso de este, los sitios visitados antes y después del mismo, el número de páginas visitadas, la dirección IP de la cual accede el usuario, la frecuencia de visitas, etc.",
			...
			<Paragraph
				...
				texts={[
					...
					"<br>No se permite la reproducción (total o parcial) de los contenidos, productos o servicios disponibles en el SITIO WEB sin la autorización expresa de <strong>Distrito Pyme S.A. de C.V.</strong> o su titular. Tampoco se permitirán manifestaciones falsas, inexactas o incorrectas sobre el SITIO WEB, ni sobre sus contenidos, productos o servicios, pudiendo <strong>Distrito Pyme S.A. de C.V.</strong> restringir el acceso al SITIO WEB a toda aquella persona que incurra en este tipo de actos.",
