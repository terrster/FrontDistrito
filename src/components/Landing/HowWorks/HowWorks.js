...
import SAT from '../../../assets/img/home/ICONO_SAT.png';
import FISICA from '../../../assets/img/home/ICONO_FISICA.png';
import MORAL from '../../../assets/img/home/ICONO_MORAL.png';
			...
			<Row className="justify-content-center mt-3">
				<Col xl={3} md={6} sm={6} className="mb-4">
					<Card  style={{ height: '28rem' }} id="card-home">
						<Icons img={SAT} alt="Firma" width="100px" />
						<Card.Body>
				...
				<Col xl={3} md={6} sm={6} className="mb-4">
					<Card style={{ height: '28rem' }} id="card-home">
						<Icons img={FISICA} alt="Firma" width="100px" />
						<Card.Body>
				...
				<Col xl={3} md={6} sm={6} className="mb-4">
					<Card style={{ height: '28rem' }} id="card-home">
						<Icons img={MORAL} alt="Firma" width="100px" />
						<Card.Body>
