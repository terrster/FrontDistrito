	...
	return (
		<div className="container mb-120">
			...
			<Paragraph 
				...
				texts={[
					"<br>El Responsable para llevar a cabo de manera correcta la prestación de sus servicios en favor del Titular, y en los caso de que el mismo pueda ser sujeto del otorgamiento del crédito solicitado por alguna de las financieras aliadas del Responsable, requiere transferir sus datos personales a las siguientes sociedades: Impulso Distrito, S.A.P.I. de C.V., Unifin Financiera, S.A.B. de C.V., Pretmex, S.A. de C.V., Advantech Servicios Financieros, S.A.P.I. de C.V., SOFOM E.N.R.,  Bien para Bien, S.A.P.I. de C.V., SOFOM E.N.R., Cumplomex, S.A. de C.V., Apjusto, S.A.P.I. de C.V., SOFOM E.N.R., Justo Lease, S.A.P.I. de C.V., Mundi Trade, INC, Factor Expres, S.A.P.I. DE C.V. SOFOM E.N.R., AV SOCIOS DE CAPITAL S.A.P.I. DE C.V. (AV Capital), HAYCASH S.A.P.I. DE C.V. (HayCash), Dimex S.A. de C.V. (Dimex), UKU S.A.P.I. de C.V. (PagaLoop), First Home Solutions S.A.P.I. de C.V. (iBan), “ION FINANCIERA”, SOCIEDAD ANÓNIMA PROMOTORA DE INVERSIÓN DE CAPITAL VARIABLE, SOCIEDAD FINANCIERA DE OBJETO MÚLTIPLE, ENTIDAD REGULADA, SGS Soluciones a tu Medida SAPI de CV SOFOM ENR (Amifin), HAPPY DAYS TECH, S.A.P.I. DE C.V. (delt.ai), Prestadora de Servicios Ciclomart S.A.P.I de C.V (Creze), Financiera Cualli, S.A.P.I. de C.V., SOFOM, E.N.R y Banca Afirme, S.A., Institución de Banca Múltiple, Afirme Grupo Financiero en adelante como “los Encargados”, con la finalidad de que dichas sociedades puedan otorgarle una propuesta de crédito en los términos y condiciones solicitadas por el Titular; por lo que el Responsable hace del conocimiento del Titular que, el Responsable tiene celebrado un contrato para la prestación de servicios con cada uno de los Encargados,  en el cual se establece el tratamiento que el Encargado deberá dar a sus datos personales con la finalidad de proteger sus datos en los casos en que los mismos sean transferidos a dicha sociedad.",
					"<br>Derivado de lo anterior, el Responsable hace de su conocimiento que, para el caso en que usted desee hacer uso de los servicios del Responsable, de manera expresa y por escrito, el Responsable recabará de usted dicho consentimiento, toda vez que, sin el mismo, el Responsable no podrá realizar la correcta prestación de sus servicios en favor del Titular, ya que la transferencia de su expediente es parte fundamental para poderle ofrecer una propuesta de crédito por parte de los Encargados."
				]}
			/>	
			...
			<br></br>
			<Title title="“Ultima actualización 17 de julio de 2020”" className="subtitle-dp fz20 text-center"/>
		</div>
	)
}
