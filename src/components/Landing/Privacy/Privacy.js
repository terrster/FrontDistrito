		...
		<div className="container mb-120">
			...
			<Paragraph 
				texts={[
					...
					'<p>Sus datos personales pueden ser transferidos y tratados dentro y fuera del país por personas distintas a DISTRITOPYME. En este sentido, su información puede ser compartida con clientes y socios comerciales, como son Impulso Distrito, S.A.P.I. de C.V. (ImpulsoMx), Unifin Financiera, S.A.B. de C.V. (Uniclick), Pretmex, S.A. de C.V. (Pretmex), Advantech Servicios Financieros, S.A.P.I. de C.V., SOFOM E.N.R. (Aspiria), Bien para Bien, S.A.P.I. de C.V., SOFOM E.N.R. (Bien para Bien), Cumplomex S.A. de C.V. (Cumplo), APJUSTO, S.A.P.I. DE C.V., SOFOM, ENR, Y JUSTO LEASE, S.A.P.I. DE C.V (CREDIJUSTO), Mundi Trade, INC (Mundi) y FACTOR EXPRÉS S.A.P.I. DE C.V. SOFOM E.N.R. (FACTOR EXPRÉS) para la realización de proyectos.</p>',
